...
public sealed class Defs
{
	...
	private static int _ABTestDeviceNumber;
	...
	public static int ABTestDeviceNumber
	{
		get
		{
			if (_ABTestDeviceNumber < 0)
			{
				string deviceModel = SystemInfo.deviceModel;
				if (deviceModel.Equals("samsung SM-T230") || deviceModel.Equals("samsung GT-I9500"))
				{
					if (PlayerPrefs.HasKey("ABTDevNum"))
					{
						_ABTestDeviceNumber = PlayerPrefs.GetInt("ABTDevNum", 0);
					}
					else
					{
						_ABTestDeviceNumber = Random.Range(1, 3);
						PlayerPrefs.SetInt("ABTDevNum", _ABTestDeviceNumber);
					}
				}
				else
				{
					_ABTestDeviceNumber = 0;
				}
			}
			return _ABTestDeviceNumber;
		}
	}
