...
internal sealed class MenuBackgroundMusic : MonoBehaviour
{
	...
	public static string[] scenetsToPlayMusicOn = new string[10]
	{
		Defs.MainMenuScene,
		"ConnectScene",
		"ConnectSceneSandbox",
	...
	{
		if (BuildSettings.BuildTargetPlatform == RuntimePlatform.IPhonePlayer && !subscribedOnFreeAwardStateChange && FreeAwardController.Instance != null)
		{
