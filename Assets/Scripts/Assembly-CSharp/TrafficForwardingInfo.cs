...
{
	private static readonly Lazy<TrafficForwardingInfo> _disabledInstance = new Lazy<TrafficForwardingInfo>(() => new TrafficForwardingInfo(null, 0, ExperienceController.maxLevel));
