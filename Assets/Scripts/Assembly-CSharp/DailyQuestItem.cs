...
public class DailyQuestItem : MonoBehaviour
{
	...
	public void FillData(int slot)
	{
		...
		if (Quest.SetActive())
		{
			...
			FlurryPluginWrapper.LogEventAndDublicateToEditor("Daily Quests", parameters, new Color32(0, byte.MaxValue, byte.MaxValue, byte.MaxValue));
			...
			FlurryPluginWrapper.LogEventAndDublicateToEditor("Daily Quests", parameters2, new Color32(0, byte.MaxValue, byte.MaxValue, byte.MaxValue));
		}
