...
namespace Rilisoft
{
	internal abstract class Preferences : ICollection<KeyValuePair<string, string>>, IDictionary<string, string>, IEnumerable<KeyValuePair<string, string>>, IEnumerable
	{
