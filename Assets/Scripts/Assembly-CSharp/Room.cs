...
public class Room : RoomInfo
{
	...
	public void SetCustomProperties(Hashtable propertiesToSet, Hashtable expectedValues)
	{
		if (propertiesToSet != null)
		{
			...
			else if (!PhotonNetwork.offlineMode)
			{
				...
				PhotonNetwork.networkingPeer.OpSetPropertiesOfRoom(gameProperties, false, expectedProperties);
			}
		}
	}
	...
	public void SetPropertiesListedInLobby(string[] propsListedInLobby)
	{
		...
		PhotonNetwork.networkingPeer.OpSetPropertiesOfRoom(hashtable, false);
