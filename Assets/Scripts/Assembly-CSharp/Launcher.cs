...
internal sealed class Launcher : MonoBehaviour
{
	...
	[CompilerGenerated]
	private sealed class _003CAppsMenuStartCoroutine_003Ec__Iterator11E : IEnumerable<float>, IEnumerator<float>, IEnumerator, IDisposable, IEnumerable
	{
		...
		IEnumerator<float> IEnumerable<float>.GetEnumerator()
		{
			...
			return new _003CAppsMenuStartCoroutine_003Ec__Iterator11E
			{
