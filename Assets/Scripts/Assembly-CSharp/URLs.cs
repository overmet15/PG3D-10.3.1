...
public class URLs
{
	...
	public static string PopularityMapUrl
	{
		get
		{
			...
			return "http://secure.pixelgunserver.com/mapstats/" + GlobalGameController.MultiplayerProtocolVersion + "_" + (int)(ConnectSceneNGUIController.myPlatformConnect - 1) + "_" + num + "_mapstat.json";
		}
	}
