...
public class TouchPadInJoystick : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (isShooting && inGameGUI.playerMoveC != null && isActiveFireButton && (TrainingController.TrainingCompleted || TrainingController.CompletedTrainingStage > TrainingController.NewTrainingCompletedStage.None || TrainingController.FireButtonEnabled) && (!Defs.isHunger || _hungerGameController.isGo))
		{
