...
internal sealed class VideoRecordingView : MonoBehaviour, IDisposable
{
	...
	public static bool IsWeakDevice
	{
		get
		{
			return (BuildSettings.BuildTargetPlatform == RuntimePlatform.Android && Defs.AndroidEdition == Defs.RuntimeAndroidEdition.Amazon) || BuildSettings.BuildTargetPlatform == RuntimePlatform.MetroPlayerX64;
		}
	}
