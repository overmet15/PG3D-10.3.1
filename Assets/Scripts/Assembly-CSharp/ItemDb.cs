...
public static class ItemDb
{
	...
	public static string GetItemName(string tag, ShopNGUIController.CategoryNames category)
	{
		...
		{
			shopPositionParams = Resources.Load<ShopPositionParams>("Armor/" + tag);
		}
		if (category == ShopNGUIController.CategoryNames.HatsCategory)
		{
			shopPositionParams = Resources.Load<ShopPositionParams>("Hats/" + tag);
		}
		if (category == ShopNGUIController.CategoryNames.CapesCategory)
		{
			shopPositionParams = Resources.Load<ShopPositionParams>("Capes/" + tag);
		}
		if (category == ShopNGUIController.CategoryNames.BootsCategory)
		{
			shopPositionParams = Resources.Load<ShopPositionParams>("Shop_Boots/" + tag);
		}
		if (category == ShopNGUIController.CategoryNames.GearCategory)
		{
			shopPositionParams = Resources.Load<ShopPositionParams>("Shop_Gear/" + tag);
		}
		if (category == ShopNGUIController.CategoryNames.MaskCategory)
		{
			shopPositionParams = Resources.Load<ShopPositionParams>("Masks/" + tag);
		}
