...
public sealed class JoinRoomFromFrends : MonoBehaviour
{
	...
	public void ConnectToRoom(int _game_mode, string _room_name, string _map)
	{
		...
		string text = Initializer.Separator + ConnectSceneNGUIController.regim.ToString() + ((!Defs.isDaterRegim) ? gameTier.ToString() : "Dater") + "v" + GlobalGameController.MultiplayerProtocolVersion;
