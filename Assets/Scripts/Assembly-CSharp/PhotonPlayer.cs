...
public class PhotonPlayer
{
	...
	public void SetCustomProperties(Hashtable propertiesToSet)
	{
		if (propertiesToSet != null)
		{
			...
			{
				PhotonNetwork.networkingPeer.OpSetCustomPropertiesOfActor(actorID, actorProperties);
			}
	...
	public void SetCustomProperties(Hashtable propertiesToSet, Hashtable expectedValues)
	{
		if (propertiesToSet != null)
		{
			...
			else if (actorID > 0 && !PhotonNetwork.offlineMode)
			{
				...
				PhotonNetwork.networkingPeer.OpSetPropertiesOfActor(actorID, actorProperties, expectedProperties);
			}
		}
	}
